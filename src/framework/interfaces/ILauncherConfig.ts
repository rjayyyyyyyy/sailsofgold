...
export const sampleConfig: ILauncherConfig = {
  ...
  gameModules: {
    bundleconfig: {
      script: "",
      resource: "resources/games/videoslot/sailsofgold/config_${CHANNEL}.json",
    },
    featurepreview: {
      script: "",
      resource:
        "resources/games/videoslot/sailsofgold/featurepreview_bundle.json",
    },
    game: {
      script: "",
      resource: "resources/games/videoslot/sailsofgold/game_bundle.json",
    },
    ui: {
      script:
        "games/videoslot/sailsofgold/ui/desktop/bookofdead_viewfactory.js",
      resource:
        "resources/games/videoslot/sailsofgold/ui_${CHANNEL}_bundle.json",
    },
    mysteryjackpot: {
      script: "",
      resource:
        "resources/games/videoslot/sailsofgold/mysteryjackpot_bundle.json",
    },
  },
  useBrowserStorage: 0,
  availableModules: [],
  gameURL: "games/videoslot/sailsofgold/bookofdead_main.js",
  ...
  integrationErrorCodes: {
    ...
    IDS_IERR_SERVICEUNAVAILABLE:
      "The system is temporarily unavailable. Please try again later",
    IDS_IERR_INVALIDIPLOCATION:
      "You are logging in from a restricted location. Your login has been denied.",
    IDS_IERR_USERISUNDERAGE:
      "You are blocked from playing these games due to being underage. If you have any questions please contact your customer support",
    IDS_IERR_SESSIONLIMITEXCEEDED:
      "Your session limit has been reached. Please exit the game and start a new game session to continue playing.",
  },
  autoplayReset: false,
  autoplayLimits: false,
  resourceRoot: "https://localhost:44321/content/6.0.0-sailsofgold.238/",
  showSplash: true,
  ...
  channel: "mobile",
  practice: 0,
  baseURL: "https://localhost:44321/content/6.0.0-sailsofgold.238/",
  showPoweredBy: true,
  language: "en_US",
  gameId: 310,
  pId: 8872,
