...
export default class GambleScene extends Phaser.Scene {
  ...
  editorCreate(): void {
    ...
    btnRed.setInteractive(
      new Phaser.Geom.Rectangle(0, 0, 217, 96),
    ...
    // btnBlack
    const btnBlack = this.add.sprite(
      403,
      435,
      "skin_texture3_level0",
      "GI.png"
    );
    btnBlack.setInteractive(
      new Phaser.Geom.Rectangle(0, 0, 217, 96),
      Phaser.Geom.Rectangle.Contains
    );
    btnBlack.scaleX = 0.8;
    ...
    // cardReveal
    const cardReveal = this.add.sprite(
      640,
      360,
      "skin_texture5_level3",
      "A-21.png"
    );
    ...
    // btnHeart
    const btnHeart = this.add.sprite(
      852,
      355,
      "skin_texture3_level0",
      "OG.png"
    );
    btnHeart.setInteractive(
      new Phaser.Geom.Rectangle(0, 0, 97, 98),
      Phaser.Geom.Rectangle.Contains
    );
    btnHeart.scaleX = 0.8;
    btnHeart.scaleY = 0.8;
    ...
    // btnDiamond
    const btnDiamond = this.add.sprite(
      932,
      355,
      "skin_texture3_level0",
      "NG.png"
    );
    btnDiamond.setInteractive(
      new Phaser.Geom.Rectangle(0, 0, 97, 98),
      Phaser.Geom.Rectangle.Contains
    );
    ...
    // btnSpade
    const btnSpade = this.add.sprite(
      932,
      430,
      "skin_texture3_level0",
      "LG.png"
    );
    btnSpade.setInteractive(
      new Phaser.Geom.Rectangle(0, 0, 97, 98),
      Phaser.Geom.Rectangle.Contains
    );
    btnSpade.scaleX = 0.8;
  ...
  create() {
    ...
    this.txtInformation.setText(
      this.cache.json.get("language").texts["IDS_VP_BONUS2"]
    );
    this.txtColorpays.setText(
      this.cache.json.get("language").texts["IDS_COLORPAYS"]
    );
    this.txtSuitpays.setText(
      this.cache.json.get("language").texts["IDS_SUITPAYS"]
    );
    this.txtRed.setText(this.cache.json.get("language").texts["IDS_INFO_RED"]);
    this.txtBlack.setText(
      this.cache.json.get("language").texts["IDS_INFO_BLACK"]
    );
    this.txtPrevCard.setText(
      this.cache.json.get("language").texts["IDS_PREVIOUSCARDS"]
    );
  ...
  pickCards(picked: number) {
    ...
    this.cardReveal = this.add
      .sprite(640, 360, "skin_texture3_level0", "PG.png")
      .setScale(0.8);
    ...
    this.cardReveal.on("animationcomplete", () => {
      ...
      if (coinsWon != 0) {
        ...
        this.btnBlack.setTexture("skin_texture3_level0", "GI.png");
        this.txtInformation.setText(
          `${this.cache.json.get("language").texts["IDS_MENU_WIN"]} ${coinsWon}`
        );
        ...
        this.txtInformation.setText(
          `${this.cache.json.get("language").texts["IDS_VP_GAMEOVER"]}`
        );
        this.btnHeart.setTexture("skin_texture3_level0", "EI.png");
        this.btnDiamond.setTexture("skin_texture3_level0", "DI.png");
        this.btnClub.setTexture("skin_texture3_level0", "CI.png");
  ...
  toggleEffect() {
    ...
    this.toggleVfx = this.tweens.addCounter({
      ...
      onUpdate: (tween) => {
        ...
        const color2 = Phaser.Display.Color.GetColor(
          colorObject2.r,
          colorObject2.g,
          colorObject2.b
        );
